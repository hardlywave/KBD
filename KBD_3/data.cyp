...
(js: Sport{name: 'Java Script', type: 'Programming Language'}),
(sql: Sport{name: 'MySQL', type: 'Database Service'}),
(python: Sport{name: 'Python', type: 'Programming Language'}),
(c++: Sport{name: 'C++', type: 'Programming Language'}),
